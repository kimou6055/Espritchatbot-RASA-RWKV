...
class GenerateResponse(Action):
    ...
    def __init__(self):
        ...
        #Server
        self.model = RWKV(model=current_path+'/RWKV-4-Raven-7B-v10-Eng99%-Other1%-20230418-ctx8192Server', strategy='cuda:0 fp16 *16 -> cuda:1 fp16 *16 -> cpu fp32')
        #Local
    ...
    async def run(self, dispatcher: CollectingDispatcher,
        ...
        try:
            ...
            input = "Act as a university advisor, respond only to questions related to universities and nothing else. Make a 20 words sentence."
